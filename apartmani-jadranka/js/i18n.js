...
(function () {
  ...
  var DICT = {
    ...
    'contact.title': { hr: 'Kontaktirajte domaćina', en: 'Contact Your Host', de: 'Kontaktieren Sie Ihre Gastgeberin', pl: 'Skontaktuj się z gospodynią', cs: 'Kontaktujte svou hostitelku' },
    'contact.subtitle': { hr: 'Imate pitanja o svom boravku? Javite nam se izravno telefonom, WhatsAppom ili e-mailom.', en: 'Questions about your stay? Reach us directly by phone, WhatsApp, or email.', de: 'Fragen zu Ihrem Aufenthalt? Erreichen Sie uns direkt per Telefon, WhatsApp oder E-Mail.', pl: 'Masz pytania dotyczące pobytu? Skontaktuj się z nami bezpośrednio telefonicznie, przez WhatsApp lub e-mailem.', cs: 'Máte dotazy ohledně svého pobytu? Kontaktujte nás přímo telefonicky, přes WhatsApp nebo e-mailem.' },
